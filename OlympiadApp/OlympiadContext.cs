...
namespace OlympiadApp
{
    public class OlympiadContext : DbContext
    {
        ...
        public DbSet<CityOlympiad> CityOlympiads { get; set; }
        public DbSet<DisciplineParticipant> DisciplineParticipants { get; set; }
        public DbSet<ParticipantTypeOfSport> ParticipantTypeOfSports { get; set; }
